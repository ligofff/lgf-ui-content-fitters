...
1. Make an [Issue](https://github.com/ligofff/lgf-ui-content-fitters/issues/new)
...
```json
    {
        "dependencies": {
            "com.ligofff.lgf-ui-content-fitters": "https://github.com/YOUR_USER/lgf-ui-content-fitters.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at support@ligofff.com.
